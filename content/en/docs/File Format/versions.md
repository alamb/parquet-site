...
| Feature                                  | V1 | V2 | V3 | Released in | Source | Notes |
|------------------------------------------| ---- | ---- | ---- | ----------------------------- | --- | ------------------------- |
...
| Adaptive Floating Point (ALP)            |  |  | ✅ | 3.0.0 |  |  |
| Fast Static String Table (FSST)          |  |  | ✅ | 3.0.0 |  |  |
| FastLanes integer encoding               |  |  | ✅ | 3.0.0 |  |  |
| Remove path_in_schema                    |  |  | ✅ | 3.0.0 |  |  |
